...
# EU languages + English (excluding unavailable languages like Maltese)
ENV LT_LOAD_ONLY="en,de,fr,it,es,pl,ro,nl,el,hu,pt,sv,cs,fi,da,sk,bg,ga,lv,lt,et,sl"
...
CMD ["./venv/bin/libretranslate", "--host", "0.0.0.0", "--port", "5000", "--load-only", "en,de,fr,it,es,pl,ro,nl,el,hu,pt,sv,cs,fi,da,sk,bg,ga,lv,lt,et,sl"]
